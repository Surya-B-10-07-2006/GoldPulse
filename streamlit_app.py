...
if predict_btn:
    try:
        ...
        for j in range(len(prices)):
            ...
            ax.text(j, prices[j], f'{prices[j]:.2f}', fontsize=7, ha='center', va='bottom', 
                   color='white', weight='bold', bbox=dict(boxstyle='round,pad=0.2', facecolor='black', edgecolor=marker_color, alpha=0.9), zorder=10)
        ...
        ax.text(len(prices), arima_price, f'{arima_price:.2f}', fontsize=7, ha='center', va='bottom', 
               color='white', weight='bold', bbox=dict(boxstyle='round,pad=0.2', facecolor='black', edgecolor='#ffd700', alpha=0.9), zorder=10)
